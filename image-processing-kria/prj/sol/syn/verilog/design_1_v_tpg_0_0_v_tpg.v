...
(* CORE_GENERATION_INFO="design_1_v_tpg_0_0_v_tpg,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xck26-sfvc784-2LV-c,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.392000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=13,HLS_SYN_DSP=0,HLS_SYN_FF=6582,HLS_SYN_LUT=7871,HLS_VERSION=2022_2}" *)
...
reg   [31:0] count;
reg   [31:0] s;
wire   [0:0] icmp_ln455_fu_543_p2;
reg   [0:0] icmp_ln455_reg_611;
wire    ap_CS_fsm_state2;
wire   [31:0] add_ln457_fu_553_p2;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_339_fid_in;
wire   [31:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TDATA;
wire   [3:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TKEEP;
wire   [3:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TSTRB;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TUSER;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TLAST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TID;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TDEST;
wire   [0:0] grp_v_tpgHlsDataFlow_fu_339_fid;
wire    grp_v_tpgHlsDataFlow_fu_339_s_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_339_ap_start;
wire    grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TVALID;
wire    grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TREADY;
wire    grp_v_tpgHlsDataFlow_fu_339_fid_ap_vld;
wire    grp_v_tpgHlsDataFlow_fu_339_ap_done;
wire    grp_v_tpgHlsDataFlow_fu_339_ap_ready;
wire    grp_v_tpgHlsDataFlow_fu_339_ap_idle;
reg    grp_v_tpgHlsDataFlow_fu_339_ap_continue;
wire   [15:0] grp_reg_unsigned_short_s_fu_537_ap_return;
reg    grp_reg_unsigned_short_s_fu_537_ap_ce;
reg   [31:0] count_new_0_reg_328;
wire   [0:0] icmp_ln458_fu_559_p2;
reg    grp_v_tpgHlsDataFlow_fu_339_ap_start_reg;
wire    ap_CS_fsm_state3;
wire    ap_CS_fsm_state4;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_ready;
wire    ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_done;
reg    ap_block_state4_on_subcall_done;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_ready;
reg    ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_done;
wire   [31:0] select_ln460_fu_591_p3;
wire   [28:0] tmp_1_fu_569_p4;
wire   [0:0] icmp_ln460_fu_579_p2;
wire   [31:0] add_ln462_fu_585_p2;
...
#0 count = 32'd0;
#0 s = 32'd0;
#0 grp_v_tpgHlsDataFlow_fu_339_ap_start_reg = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_ready = 1'b0;
#0 ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_done = 1'b0;
end

design_1_v_tpg_0_0_v_tpgHlsDataFlow grp_v_tpgHlsDataFlow_fu_339(
...
design_1_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_537(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
    .d(bck_motion_en),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_done <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_done <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_339_ap_done == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_done <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_ready <= 1'b0;
    end else begin
        if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_ready <= 1'b0;
        end else if ((grp_v_tpgHlsDataFlow_fu_339_ap_ready == 1'b1)) begin
            ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_ready <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        grp_v_tpgHlsDataFlow_fu_339_ap_start_reg <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) | ((ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_ready == 1'b0) & (1'b1 == ap_CS_fsm_state4)))) begin
            grp_v_tpgHlsDataFlow_fu_339_ap_start_reg <= 1'b1;
        end else if ((grp_v_tpgHlsDataFlow_fu_339_ap_ready == 1'b1)) begin
            grp_v_tpgHlsDataFlow_fu_339_ap_start_reg <= 1'b0;
        end
    end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln455_fu_543_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        if ((icmp_ln458_fu_559_p2 == 1'd0)) begin
            count_new_0_reg_328 <= add_ln457_fu_553_p2;
        end else if ((icmp_ln458_fu_559_p2 == 1'd1)) begin
            count_new_0_reg_328 <= 32'd0;
        end
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln455_reg_611 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln455_fu_543_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (icmp_ln458_fu_559_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1)))) begin
        grp_reg_unsigned_short_s_fu_537_ap_ce = 1'b1;
    end else begin
        grp_reg_unsigned_short_s_fu_537_ap_ce = 1'b0;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_state4_on_subcall_done) & (1'b1 == ap_CS_fsm_state4))) begin
        grp_v_tpgHlsDataFlow_fu_339_ap_continue = 1'b1;
    end else begin
        grp_v_tpgHlsDataFlow_fu_339_ap_continue = 1'b0;
    end
end
...
assign add_ln457_fu_553_p2 = (count + 32'd1);

assign add_ln462_fu_585_p2 = (s + 32'd1);
...
always @ (*) begin
    ap_block_state4_on_subcall_done = ((ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_ready & ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_done) == 1'b0);
end
...
assign ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_done = (grp_v_tpgHlsDataFlow_fu_339_ap_done | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_done);

assign ap_sync_grp_v_tpgHlsDataFlow_fu_339_ap_ready = (grp_v_tpgHlsDataFlow_fu_339_ap_ready | ap_sync_reg_grp_v_tpgHlsDataFlow_fu_339_ap_ready);

assign fid = grp_v_tpgHlsDataFlow_fu_339_fid;

assign grp_v_tpgHlsDataFlow_fu_339_ap_start = grp_v_tpgHlsDataFlow_fu_339_ap_start_reg;

assign grp_v_tpgHlsDataFlow_fu_339_fid_in = fid_in;

assign grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TREADY = (m_axis_video_TREADY_int_regslice & ap_CS_fsm_state4);

assign icmp_ln455_fu_543_p2 = ((grp_reg_unsigned_short_s_fu_537_ap_return == 16'd1) ? 1'b1 : 1'b0);

assign icmp_ln458_fu_559_p2 = ((add_ln457_fu_553_p2 == 32'd10) ? 1'b1 : 1'b0);

assign icmp_ln460_fu_579_p2 = (($signed(tmp_1_fu_569_p4) < $signed(29'd1)) ? 1'b1 : 1'b0);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign m_axis_video_TVALID_int_regslice = grp_v_tpgHlsDataFlow_fu_339_m_axis_video_TVALID;

assign s_axis_video_TREADY = regslice_both_s_axis_video_V_data_V_U_ack_in;

assign select_ln460_fu_591_p3 = ((icmp_ln460_fu_579_p2[0:0] == 1'b1) ? add_ln462_fu_585_p2 : 32'd0);

assign tmp_1_fu_569_p4 = {{s[31:3]}};
