...
attribute shreg_extract : string;
    ...
    signal AXIvideo2MultiPixStream_U0_srcYUV_num_data_valid : STD_LOGIC_VECTOR (4 downto 0);
    signal AXIvideo2MultiPixStream_U0_srcYUV_fifo_cap : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal srcYUV_num_data_valid : STD_LOGIC_VECTOR (5 downto 0);
    signal srcYUV_fifo_cap : STD_LOGIC_VECTOR (5 downto 0);
    ...
    component design_1_v_tpg_0_0_fifo_w30_d21_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    srcYUV_U : component design_1_v_tpg_0_0_fifo_w30_d21_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    AXIvideo2MultiPixStream_U0_srcYUV_fifo_cap <= srcYUV_fifo_cap(5 - 1 downto 0);
    AXIvideo2MultiPixStream_U0_srcYUV_num_data_valid <= srcYUV_num_data_valid(5 - 1 downto 0);
