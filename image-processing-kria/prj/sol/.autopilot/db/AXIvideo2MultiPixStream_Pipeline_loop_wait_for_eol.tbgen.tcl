...
set C_modelArgList {
	...
	{ axi_data_V_8_out int 30 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "axi_data_2_lcssa", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_8_out", "interface" : "wire", "bitwidth" : 30, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ axi_data_V_8_out sc_out sc_lv 30 signal 10 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_8_out", "direction": "out", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "axi_data_V_8_out", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	axi_data_V_8_out { ap_vld {  { axi_data_V_8_out out_data 1 30 }  { axi_data_V_8_out_ap_vld out_vld 1 1 } } }
