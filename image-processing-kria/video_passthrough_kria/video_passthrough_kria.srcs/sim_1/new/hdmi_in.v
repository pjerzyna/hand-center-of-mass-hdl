...
begin
  ...
  begin  
    ...
    //rgbfile = $fopen("/home/pawsooon/Vivado/tor_wizyjny/video_passthrough_kria/geirangerfjord_64.ppm","rb");
    //trzeba uwazac, bo nazwa moze byc za dluga!!!
    rgbfile = $fopen("/home/pawsooon/Documents/github_projects/wykrywanie_reki_repo/contextual-image-processing-kria/video_passthrough_kria/dlon.ppm","rb");
