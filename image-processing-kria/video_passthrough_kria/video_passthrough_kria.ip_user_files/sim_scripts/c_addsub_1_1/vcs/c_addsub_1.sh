...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../video_passthrough_kria.gen/sources_1/ip/c_addsub_1_1/sim/c_addsub_1.vhd" \
  2>&1 | tee -a vhdlan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/pawsooon/Vivado/binaryzacja/video_passthrough_kria/video_passthrough_kria.cache/compile_simlib/vcs"
  fi
