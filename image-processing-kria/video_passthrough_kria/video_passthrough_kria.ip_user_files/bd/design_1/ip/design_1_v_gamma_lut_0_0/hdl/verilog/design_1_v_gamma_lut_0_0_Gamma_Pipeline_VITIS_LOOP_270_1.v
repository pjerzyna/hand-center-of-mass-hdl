...
always @ (posedge ap_clk) begin
    if (((icmp_ln270_fu_142_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        i_cast_reg_191[10 : 0] <= i_cast_fu_154_p1[10 : 0];
    end
end
...
assign add_ln270_fu_148_p2 = (ap_sig_allocacmp_i_1 + 11'd1);
...
assign icmp_ln270_fu_142_p2 = ((ap_sig_allocacmp_i_1 == 11'd1024) ? 1'b1 : 1'b0);

assign lut_0_V_0_address0 = i_cast_reg_191;

assign lut_0_V_0_d0 = gamma_lut_0_q0[9:0];

assign lut_1_V_0_address0 = i_cast_reg_191;

assign lut_1_V_0_d0 = gamma_lut_1_q0[9:0];

assign lut_2_V_0_address0 = i_cast_reg_191;

assign lut_2_V_0_d0 = gamma_lut_2_q0[9:0];

always @ (posedge ap_clk) begin
    i_cast_reg_191[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
end
