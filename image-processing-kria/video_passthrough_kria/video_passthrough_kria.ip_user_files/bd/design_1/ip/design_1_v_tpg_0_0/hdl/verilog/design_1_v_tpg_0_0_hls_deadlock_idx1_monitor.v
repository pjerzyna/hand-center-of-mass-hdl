...
module design_1_v_tpg_0_0_hls_deadlock_idx1_monitor ( // for module design_1_v_tpg_0_0_v_tpg_inst.grp_v_tpgHlsDataFlow_fu_339
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[0] = idx2_block & (1'b0 | axis_block_sigs[2] | axis_block_sigs[1] | axis_block_sigs[0]);
