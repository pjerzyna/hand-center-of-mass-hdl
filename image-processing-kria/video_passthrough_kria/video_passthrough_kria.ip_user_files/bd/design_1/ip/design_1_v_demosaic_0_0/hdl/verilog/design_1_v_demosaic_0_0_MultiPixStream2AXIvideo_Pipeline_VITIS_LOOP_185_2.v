...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((m_axis_video_TREADY == 1'b0) & (icmp_ln1027_reg_197 == 1'd0)) | ((icmp_ln1027_reg_197 == 1'd0) & (imgUnzip_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((m_axis_video_TREADY == 1'b0) & (icmp_ln1027_reg_197 == 1'd0)) | ((icmp_ln1027_reg_197 == 1'd0) & (imgUnzip_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state2_io) | ((m_axis_video_TREADY == 1'b0) & (icmp_ln1027_reg_197 == 1'd0)) | ((icmp_ln1027_reg_197 == 1'd0) & (imgUnzip_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((m_axis_video_TREADY == 1'b0) & (icmp_ln1027_reg_197 == 1'd0)) | ((icmp_ln1027_reg_197 == 1'd0) & (imgUnzip_empty_n == 1'b0)));
end
...
assign icmp_ln1027_fu_153_p2 = ((ap_sig_allocacmp_j_V_1 == WidthOut) ? 1'b1 : 1'b0);
